...
public class UpdateProductDAO {
	public boolean update(ProductBean pb)
	{
		...
		try{
			...
			PreparedStatement pstat = con.prepareStatement("UPDATE PRODUCT1 SET PRODUCT_ID=?,PRODUCT_NAME=?,PRODUCT_CATEGORY=?,PRODUCT_STATUS=?,PRODUCT_PRICE=?,PRODUCT_DESC=? WHERE PRODUCT_ID=?");
